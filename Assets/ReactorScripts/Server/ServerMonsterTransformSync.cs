...
public class ServerMonsterTransformSync : ksServerEntityScript
{
    [ksEditable]
    ...
    private void SetTransform(ksIServerPlayer player, ksVector3 position, ksQuaternion rotation, float deltaTime)
    {
